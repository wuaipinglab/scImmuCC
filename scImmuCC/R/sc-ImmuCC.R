...
scImmuCC_Layered <- function(count,Non_Immune=TRUE){
  ...
  # load("./data/layer1_genelist.rda")
  # load("./data/Tcell_genelist.rda")
  # load("./data/Bcell_genelist.rda")
  # load("./data/DC_genelist.rda")
  # load("./data/NK_genelist.rda")
  # load("./data/Monocyte_genelist.rda")
  # load("./data/Macrophage_genelist.rda")
  # load("./data/ILC_genelist.rda")
  # load("./data/CD4_genelist.rda")
  # load("./data/CD8_genelist.rda")
  # load("./data/layer0_genelist.rda")
